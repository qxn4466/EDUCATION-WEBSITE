    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-r from-blue-600 via-green-600 to-orange-600 text-white overflow-hidden pt-12">
        ...
        <div className="container mx-auto px-4 py-8 md:py-12 relative z-10">
          <div className="flex justify-center mb-4">
            <div className="relative w-32 h-32 md:w-48 md:h-48 rounded-full overflow-hidden shadow-2xl border-4 border-white/30">
              <Image
          ...
          <p className="text-base md:text-xl text-center max-w-3xl mx-auto text-white/90 px-4">
      ...
      <div className="container mx-auto px-4 mt-6 md:mt-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6">
          <div className="bg-white rounded-xl shadow-md p-3 md:p-5 text-center hover:shadow-lg transition">
            <div className="w-10 h-10 md:w-14 md:h-14 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-2 md:mb-3">
              <FaClock className="text-blue-600 text-lg md:text-2xl" />
            </div>
            <h3 className="font-bold text-gray-800 text-sm md:text-base">Flexible Timings</h3>
            <p className="text-gray-500 text-xs md:text-sm">Choose your batch</p>
          </div>
          <div className="bg-white rounded-xl shadow-md p-3 md:p-5 text-center hover:shadow-lg transition">
            <div className="w-10 h-10 md:w-14 md:h-14 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-2 md:mb-3">
              <FaUsers className="text-green-600 text-lg md:text-2xl" />
            </div>
            <h3 className="font-bold text-gray-800 text-sm md:text-base">Small Batches</h3>
            <p className="text-gray-500 text-xs md:text-sm">Personal attention</p>
          </div>
          <div className="bg-white rounded-xl shadow-md p-3 md:p-5 text-center hover:shadow-lg transition">
            <div className="w-10 h-10 md:w-14 md:h-14 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-2 md:mb-3">
              <FaBook className="text-purple-600 text-lg md:text-2xl" />
            </div>
            <h3 className="font-bold text-gray-800 text-sm md:text-base">All Subjects</h3>
            <p className="text-gray-500 text-xs md:text-sm">Comprehensive coverage</p>
          </div>
          <div className="bg-white rounded-xl shadow-md p-3 md:p-5 text-center hover:shadow-lg transition">
            <div className="w-10 h-10 md:w-14 md:h-14 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-2 md:mb-3">
              <FaChalkboardTeacher className="text-orange-600 text-lg md:text-2xl" />
            </div>
            <h3 className="font-bold text-gray-800 text-sm md:text-base">Expert Faculty</h3>
            <p className="text-gray-500 text-xs md:text-sm">Experienced teachers</p>
          </div>
        </div>
      </div>

      <div className="container mx-auto px-4 py-8 md:py-12">
        {/* Weekdays - Card View for Mobile */}
            ...
            {weekdaysSchedule.map((slot, idx) => (
              <div key={idx} className="bg-white rounded-xl shadow-md p-4 border border-gray-100">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-bold text-blue-600">{slot.time}</span>
                </div>
                <div className="mb-1">
              ...
              <table className="w-full min-w-[600px]">
                <thead className="bg-gradient-to-r from-blue-50 to-blue-100">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-sm font-semibold text-blue-800">Class</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-blue-800">Subject</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-blue-800">Teacher</th>
                  </tr>
                </thead>
          ...
          <div className="space-y-3 md:hidden">
            {saturdaySchedule.map((slot, idx) => (
              <div key={idx} className="bg-white rounded-xl shadow-md p-4 border border-gray-100">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-2xl">{slot.icon}</span>
                  <span className="font-bold text-green-600">{slot.time}</span>
                </div>
                <div className="mb-1">
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[600px]">
                <thead className="bg-gradient-to-r from-green-50 to-green-100">
                  <tr>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-green-800">Time</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-green-800">Class</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-green-800">Subject</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-green-800">Teacher</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  {saturdaySchedule.map((slot, idx) => (
          ...
          <div className="space-y-3 md:hidden">
            {sundaySchedule.map((slot, idx) => (
              <div key={idx} className="bg-white rounded-xl shadow-md p-4 border border-gray-100">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-2xl">{slot.icon}</span>
                  <span className="font-bold text-purple-600">{slot.time}</span>
                </div>
                <div className="mb-1">
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[600px]">
                <thead className="bg-gradient-to-r from-purple-50 to-purple-100">
                  <tr>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-purple-800">Time</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-purple-800">Class</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-purple-800">Subject</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-purple-800">Teacher</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  {sundaySchedule.map((slot, idx) => (
